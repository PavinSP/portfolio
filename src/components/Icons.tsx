...
export const GithubIcon = ({ size = 20 }: IconProps) => (
  <svg className="gh-mark" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
/** Small glyph used on project/certificate links. */
